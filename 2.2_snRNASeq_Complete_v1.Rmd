...
# Get all sheet names
sheet_names <- excel_sheets("/home/matthew/data/top50_genes_per_cluster.xlsx")

# Read all sheets and combine them into one dataframe
cluster_genes <- map_dfr(sheet_names,                    ~read_excel("/home/matthew/data/top50_genes_per_cluster.xlsx", 
                                   sheet = .x))
...
saveWorkbook(wb, "/home/matthew/data/SC1_top50_genes_per_cluster.xlsx", overwrite = TRUE)

# ---- Load Annotations and Merge ----
# Load Seurat top 50 markers per cluster 

# Get all sheet names
sheet_names <- excel_sheets("/home/matthew/data/SC1_top50_genes_per_cluster.xlsx")

# Read all sheets and combine them into one dataframe
cluster_genes <- map_dfr(sheet_names,                    ~read_excel("/home/matthew/data/SC1_top50_genes_per_cluster.xlsx", 
                                   sheet = .x))
...
saveWorkbook(wb, "/home/matthew/data/SC1_top50_genes_annotated.xlsx", overwrite = TRUE)
```
...
saveWorkbook(wb, "/home/matthew/data/SC2_top50_genes_per_cluster.xlsx", overwrite = TRUE)

# ---- Load Annotations and Merge ----
# Load Seurat top 50 markers per cluster 

# Get all sheet names
sheet_names <- excel_sheets("/home/matthew/data/SC2_top50_genes_per_cluster.xlsx")

# Read all sheets and combine them into one dataframe
cluster_genes <- map_dfr(sheet_names,                    ~read_excel("/home/matthew/data/SC2_top50_genes_per_cluster.xlsx", 
                                   sheet = .x))
...
saveWorkbook(wb, "/home/matthew/data/SC2_top50_genes_annotated.xlsx", overwrite = TRUE)
```
...
saveWorkbook(wb, "/home/matthew/data/SC3_top50_genes_per_cluster.xlsx", overwrite = TRUE)

# ---- Load Annotations and Merge ----
# Load Seurat top 50 markers per cluster 

# Get all sheet names
sheet_names <- excel_sheets("/home/matthew/data/SC3_top50_genes_per_cluster.xlsx")

# Read all sheets and combine them into one dataframe
cluster_genes <- map_dfr(sheet_names,                    ~read_excel("/home/matthew/data/SC3_top50_genes_per_cluster.xlsx", 
                                   sheet = .x))
...
saveWorkbook(wb, "/home/matthew/data/SC3_top50_genes_annotated.xlsx", overwrite = TRUE)
```
...
saveWorkbook(wb, "/home/matthew/data/SC4_top50_genes_per_cluster.xlsx", overwrite = TRUE)

# ---- Load Annotations and Merge ----
# Load Seurat top 50 markers per cluster 

# Get all sheet names
sheet_names <- excel_sheets("/home/matthew/data/SC4_top50_genes_per_cluster.xlsx")

# Read all sheets and combine them into one dataframe
cluster_genes <- map_dfr(sheet_names,                    ~read_excel("/home/matthew/data/SC4_top50_genes_per_cluster.xlsx", 
                                   sheet = .x))
...
saveWorkbook(wb, "/home/matthew/data/SC4_top50_genes_annotated.xlsx", overwrite = TRUE)
```
